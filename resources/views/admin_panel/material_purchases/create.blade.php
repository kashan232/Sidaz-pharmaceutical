...
<div class="sup-page container-fluid px-3 px-md-4 pt-3">
    <div class="sup-header d-flex align-items-center justify-content-between">
        <div>
            <h3 class="sup-title"><i class="fas fa-shopping-cart text-primary me-2"></i>New Material Purchase</h3>
            <div class="sup-sub">Create purchase invoice for Raw & Packaging materials</div>
        </div>
    ...
    <div class="sup-card">
        <form action="{{ route('material-purchases.store') }}" method="POST" id="purchaseForm">
            @csrf
            <div class="p-4">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="invoice_no" class="form-control" value="{{ $nextInvoice }}" readonly>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row mb-4">
                    <div class="col-md-8">
                        ...
                        <div class="row g-2">
                            <div class="col-md-3"><input type="text" name="transport_name" class="form-control" placeholder="Transport Name"></div>
                            <div class="col-md-3"><input type="text" name="driver_name" class="form-control" placeholder="Driver Name"></div>
                            <div class="col-md-3"><input type="text" name="vehicle_no" class="form-control" placeholder="Vehicle No"></div>
                            <div class="col-md-3">
                                <input type="number" step="0.01" name="transport_charges" id="transport_charges" class="form-control" placeholder="Transport Charges (Rs)" oninput="calcTotal()">
                            </div>
                            <div class="col-md-12"><textarea name="remarks" class="form-control mt-2" rows="2" placeholder="Remarks..."></textarea></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="bg-light p-3 rounded border">
                            ...
                            <div class="mb-2 d-none" id="paymentAccountDiv">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" step="0.01" name="paid_amount" id="paidAmount" class="form-control form-control-sm" value="0" oninput="calcTotal()">
                            </div>
